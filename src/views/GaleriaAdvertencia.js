...
const GaleriaAdvertencia = ({ navigation }) => {
  return (
    <View style={tw`flex-1 justify-center items-center bg-white p-5`}>
      ...
      <View style={tw`w-4/5 p-5 border border-gray-300 rounded-md mb-8`}>
        <Image
          ...
          resizeMode="contain"
        />
        <Text style={tw`text-center text-lg font-semibold text-gray-700`}>Es necesario permitir el acceso a la galería para continuar</Text>
      </View>
...
export default GaleriaAdvertencia;
